...
class Trending extends StatelessWidget {
 ...
 const Trending({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return  GetBuilder<TrendingController>(
        init: TrendingController(),
    builder: (TrendingController controller) {
    ...
    Text("Trending",style: TextStyle(color:Color(0xff5F6162),fontFamily: kPoppins,fontWeight: FontWeight.w500,fontSize: 25 ),),
